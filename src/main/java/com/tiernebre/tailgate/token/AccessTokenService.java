...
public interface AccessTokenService {
     ...
     */
    String createOne(CreateAccessTokenRequest createAccessTokenRequest) throws UserNotFoundForTokenException, GenerateAccessTokenException, InvalidCreateTokenRequestException;
}
